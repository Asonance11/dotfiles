...
if [ $? -eq 0 ]; then
    ...
    if [ -f "/home/oluwadabira/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/oluwadabira/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/oluwadabira/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<

export PATH=$PATH:/home/oluwadabira/.spicetify
